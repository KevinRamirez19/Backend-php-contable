...
<body>
    ...
    <h2>#<?php echo e($venta->numero_factura); ?></h2>

    <div class="section">
        <p><span class="label">Fecha:</span> <?php echo e($fechaFormateada ?? 'No registrada'); ?></p>
        <p><span class="label">Estado DIAN:</span> <?php echo e($venta->estado_dian ?? 'Generada'); ?></p>
    </div>
    ...
    <div class="section">
        <h3>Cliente</h3>
        <p><span class="label">Nombre:</span> <?php echo e($cliente->nombre ?? 'No registrado'); ?></p>
        <p><span class="label">Identificación:</span> <?php echo e($identText); ?></p>
        <p><span class="label">Dirección:</span> <?php echo e($cliente->direccion ?? 'No registrada'); ?></p>
    </div>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td style="font-size:11px"><?php echo e($detalle->vehiculo->marca); ?> <?php echo e($detalle->vehiculo->modelo); ?> <?php echo e($detalle->vehiculo->año); ?> - <?php echo e($detalle->vehiculo->color ?? ''); ?></td>
                    <td style="text-align:center"><?php echo e($detalle->cantidad); ?></td>
                    <td style="text-align:right">$<?php echo e($fmt($detalle->precio_unitario)); ?></td>
                    <td style="text-align:right">$<?php echo e($fmt($detalle->subtotal)); ?></td>
                </tr>
    ...
    <div class="totales">
        <p>Subtotal: <strong>$<?php echo e($fmt($venta->subtotal)); ?></strong></p>
        <p>IVA (19%): <strong>$<?php echo e($fmt($venta->iva)); ?></strong></p>
        <p style="font-size:15px"><strong>Total: $<?php echo e($fmt($venta->total)); ?></strong></p>
    </div>

    <div class="firma">
        <p><strong>Firma Digital:</strong> AUTOMORATA S.A.S.</p>
        <p><strong>CUFE:</strong></p>
        <p class="cufe"><?php echo e($venta->cufe ?? 'No generado'); ?></p>
    </div>
</body>
</html>
<?php /**PATH C:\Users\ASUS\Downloads\Backend-php-contable\resources\views/facturas/factura.blade.php ENDPATH**/ ?>